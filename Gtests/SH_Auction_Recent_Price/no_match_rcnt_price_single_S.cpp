...
// stock = ("600311") 荣华实业
//	SingleNoMatchCancelWithQuotation_S.RecentMatchPrice_1
TEST(SingleNoMatchCancelWithQuotation_S, RecentMatchPrice_1)
{
	//切换模式
...
// account = "A645078963" 股票账号
// stock = ("600311") 荣华实业
//	SingleNoMatchCancelWithQuotation_S.RecentMatchPrice_2
TEST(SingleNoMatchCancelWithQuotation_S, RecentMatchPrice_2)
{
	//切换模式
	ASSERT_EQ(0, TransformMatchMode(RecentMatchPrice));
	ASSERT_EQ(0, TransformMatchMode(CheckAssetNO));
