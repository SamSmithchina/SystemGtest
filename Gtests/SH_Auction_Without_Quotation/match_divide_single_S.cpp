...
//单个测试样例；
//	SingleMatchDivideWithoutQuotation_S.MatchDivide_1
TEST(SingleMatchDivideWithoutQuotation_S, MatchDivide_1)
{
	//切换模式
...
//单个测试样例；
//	SingleMatchDivideWithoutQuotation_S.MatchDivide_2
TEST(SingleMatchDivideWithoutQuotation_S, MatchDivide_2)
{
	//切换模式
	ASSERT_EQ(0, TransformMatchMode(SimulMatchByDivide));
	ASSERT_EQ(0, TransformMatchMode(CheckAssetNO));
...
//单个测试样例；
//	SingleMatchDivideWithoutQuotation_S.MatchDivide_3
TEST(SingleMatchDivideWithoutQuotation_S, MatchDivide_3)
{
	//切换模式
	ASSERT_EQ(0, TransformMatchMode(SimulMatchByDivide));
	ASSERT_EQ(0, TransformMatchMode(CheckAssetNO));
...
//单个测试样例；
//	SingleMatchDivideWithoutQuotation_S.MatchDivide_4
TEST(SingleMatchDivideWithoutQuotation_S, MatchDivide_4)
{
	//切换模式
	ASSERT_EQ(0, TransformMatchMode(SimulMatchByDivide));
	ASSERT_EQ(0, TransformMatchMode(CheckAssetNO));
...
//单个测试样例；
//	SingleMatchDivideWithoutQuotation_S.MatchDivideCheckAsset_5
// 验股实例  增加验股测试样例， 
TEST(SingleMatchDivideWithoutQuotation_S, MatchDivideCheckAsset_5)
{
	//切换模式
	ASSERT_EQ(0, TransformMatchMode(SimulMatchByDivide));
...
//单个测试样例；
//	SingleMatchDivideWithoutQuotation_S.MatchDivideCheckAsset_6
// 增加验股实例  增加验股测试样例， 
TEST(SingleMatchDivideWithoutQuotation_S, MatchDivideCheckAsset_6)
{
	//切换模式
	ASSERT_EQ(0, TransformMatchMode(SimulMatchByDivide));
	ASSERT_EQ(0, TransformMatchMode(CheckAssetYES));
