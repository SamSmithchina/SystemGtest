...
//	SingleNoMatchCancelWithoutQuotation_S.NoMatchCancel_1
TEST(SingleNoMatchCancelWithoutQuotation_S, NoMatchCancel_1)
{
	//切换模式
...
//	SingleNoMatchCancelWithoutQuotation_S.NoMatchCancel_2
TEST(SingleNoMatchCancelWithoutQuotation_S, NoMatchCancel_2)
{
	//切换模式
	ASSERT_EQ(0, TransformMatchMode(SimulNotMatch));
	ASSERT_EQ(0, TransformMatchMode(CheckAssetNO));
...
//	SingleNoMatchCancelWithoutQuotation_S.NoMatchCancel_3
TEST(SingleNoMatchCancelWithoutQuotation_S, NoMatchCancel_3)
{
	//切换模式
	ASSERT_EQ(0, TransformMatchMode(SimulNotMatch));
	ASSERT_EQ(0, TransformMatchMode(CheckAssetNO));
