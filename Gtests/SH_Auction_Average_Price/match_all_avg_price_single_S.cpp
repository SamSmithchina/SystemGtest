...
//			SingleGtestMatchAllWithQuotation_S.AveragePrice_1
TEST(SingleGtestMatchAllWithQuotation_S, AveragePrice_1)
{
	int iRes = 0;
	//切换模式
...
// 实盘下推送行情，全部成交，卖单，区间段均价 验股，  
//			SingleGtestMatchAllWithQuotation_S.AveragePriceCheckAssert_2
TEST(SingleGtestMatchAllWithQuotation_S, AveragePriceCheckAssert_2)
{
	int iRes = 0;
	//切换模式
	ASSERT_EQ(0, TransformMatchMode(AveragePrice));
