...
TEST(SingleNoMatchCancelWithQuotation_S, AveragePrice_1)
{
	...
	aStockQuot.zqdm = "600386";
	aStockQuot.zqmc = "北巴传媒";
...
// account = "A645078963" 股票账号
// stock = ("600373") 中文传媒
//	SingleNoMatchCancelWithQuotation_S.AveragePrice_3
TEST(SingleNoMatchCancelWithQuotation_S, AveragePrice_3)
{
	//切换模式
	ASSERT_EQ(0, TransformMatchMode(AveragePrice));
	ASSERT_EQ(0, TransformMatchMode(CheckAssetNO));
	...
	AStockQuot aStockQuot;				//行情CJSL = 100000
	CreateQuotation(aStockQuot);
	aStockQuot.zqdm = "600373";
	aStockQuot.zqmc = "中文传媒";
