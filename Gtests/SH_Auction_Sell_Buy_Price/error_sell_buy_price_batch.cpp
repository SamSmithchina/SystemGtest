...
// 买一价1.050元，卖一价1.045元 ，批量处理实盘下错误价格订单,  不验股
// account = "A645078963" 股票账号
// stock = ("600312") 平高电气
//	 BatchGtestErrorWithQuotation.BatchError_SellBuyPriceCheckAssetNO
TEST(BatchGtestErrorWithQuotation, BatchError_SellBuyPriceCheckAssetNO)
{
	//切换模式
...
// 买一价1.050元，批量处理实盘下不合理价格订单, 验股时卖单数量超出股份持有数量，导致错单
// account = "A645078963" 股票账号
// stock = ("600333") 长春燃气
//	 BatchGtestErrorWithQuotation.BatchError_SellBuyPriceCheckAssetYES
TEST(BatchGtestErrorWithQuotation, BatchError_SellBuyPriceCheckAssetYES)
{
	//切换模式
	ASSERT_EQ(0, TransformMatchMode(SellBuyPrice));
	ASSERT_EQ(0, TransformMatchMode(CheckAssetNO));
