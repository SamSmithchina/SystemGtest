...
// account = "A645078963" 
// stock = "600335" 国机汽车
//		SingleMatchDivideWithQuotation_B.SellBuyPrice_1
TEST(SingleMatchDivideWithQuotation_B, SellBuyPrice_1)
{
	//切换模式
	...
	aStockQuot.zqdm = "600335";
	aStockQuot.zqmc = "国机汽车";
	...
	Tgw_StringUtil::iLiToStr(aStockQuot.SJW1, aSHShare.cjjg, 3); //最近成交价格
	ui64Price = aStockQuot.SJW1;
...
// aStockQuot.zqdm = "600337";
// aStockQuot.zqmc = "美克家居";
//		SingleMatchDivideWithQuotation_B.SellBuyPriceCheckAsset_2
TEST(SingleMatchDivideWithQuotation_B, SellBuyPriceCheckAsset_2)
{
	//切换模式
	ASSERT_EQ(0, TransformMatchMode(SellBuyPrice));
